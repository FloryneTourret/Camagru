...
Class Profile_model extends Model
{
    ...
    public function get_image($id){
        $req = $this->db->prepare("SELECT `picture_id`, `picture_path`, `picture_desc`, `picture_user_id`, `picture_date`, `user_id`, `firstname`, `lastname`, `login`, `email`, `biography`, `path_profile_picture`, `password`, `admin`, `enabled`,
